...
namespace _02_tydz__Typy_danych__V3
{
    public class Menu
    {
        ...
        {
            //string prompt = "Użyj strzałki (" + Strings.ChrW(8593) + ", " + Strings.ChrW(8595) + "), Zatwierdź Enter (" + Strings.ChrW(8626) + ")";
            ...
            Console.Clear();
            //Console.WriteLine("Szerokość okna: " + Console.BufferWidth);
            //Console.WriteLine("Wysokość  okna: " + Console.BufferHeight);
            //Console.ReadLine();
